...
LEFT JOIN                                        
 (SELECT                                       
    ...
    SUM(CASE   
             ...
             WHEN DBO.Friday(DueDate) > DBO.Friday(ebSysDate) AND IsNull(WaivableInt,1) = 1   and duedate<= DOMATURITY + 6 - Datepart(dw,domaturity)     and m.accttype not in (420,461,475,323,321,483)                                  
