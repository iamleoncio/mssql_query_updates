alter FUNCTION dbo.fn_SemiMonthly      
(      
    @acc VARCHAR(22)      
)      
...
BEGIN      
    ...
    FROM (      
    SELECT     
        DATEADD(DAY, 7 * (n.n - 1), DATEADD(DAY, -21, l.origDueDt)) AS duedate,    
        CASE n.n    
    ...
    UNION ALL    
    SELECT     
        DATEADD(DAY, -7, l.origDueDt) AS duedate,      
    ...
    WHERE x.duedate > EBSYSDATE + 6 - DATEPART(dw, EBSYSDATE)     
